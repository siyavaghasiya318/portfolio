...
const AboutDetail = () => {
    return (
        <>
            ...
            <div className="lg:flex items-center gap-10  lg:mt-0 mb-10">
                ...
                <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.8 }} className="lg:w-1/2 text-gray-200  text-md capitalize lg:mt-10 mt-10">
