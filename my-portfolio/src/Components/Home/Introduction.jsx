...
const Introduction = () => {
  return (
    <motion.div initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.6,delay: 0.5 }} viewport={{
      ...
      <div className="flex lg:w-[70%] flex-col gap-3 order-2 lg:order-1">
        <p className="text-[50px] font-bold">Hii, I'm SIYA </p>
        <p className="text-2xl font-bold bg-gradient-to-br to-[#2729c9] -500 from-[#22d3ee] -600 bg-clip-text text-transparent">MERN Stack Developer</p>
        ...
        <a href='#project' className='w-fit shadow-xl hover:shadow-indigo-600/20 px-10 my-5 py-2 bg- rounded-md outline-0 hover:scale-105 transition-all duration-300  uppercase text-sm font-bold tracking-wider bg-gradient-to-br to-[#0b7080]  from-[#2729c9] cursor-pointer'>
          View Projects
        </a>

      </div>

      <div className="w-[] relative flex flex-col justify-between items-center lg:order-2 order-1">
        <div className="absolute inset-10 bg-blue-500/20 blur-[90px]"></div>
        <div className="h-85 w-110 relative border-1 rounded-3xl border-[#22d3ee]/20 ">
